    ...
    <header className="bg-(--prim) text-white py-16">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="flex flex-wrap gap-4 text-sm">
          <a href="mailto:mehdi.dev77@gmail.com" target='_blank' rel="noopener noreferrer" className="hover:underline flex items-center gap-2">
            <MdEmail size={20} />
            mehdi.dev77@gmail.com
          </a>
          <a href="tel:+212690163841" target='_blank' rel='noopener noreferrer' className="hover:underline flex items-center gap-2">
            <MdPhone size={20} />
            +212 6 90 16 38 41
          </a>
          ...
          <a href="https://github.com/Mehdi-dev7" target='_blank' rel="noopener noreferrer" className="hover:underline flex items-center gap-2">
            <FaGithub size={20} />
            GitHub
          </a>
